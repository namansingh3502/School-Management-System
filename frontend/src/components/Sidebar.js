...
const Sidebar = (props) => {
  ...
  const navlist = [
    ...
    { name:"Student Marksheet", icon:<FaUsers size="1.5em"/>, nexturl:"student-marksheet" },
    { name:"Student Attendence", icon:<FaUsers size="1.5em"/>, nexturl:"student-attendence" },
  ]
  ...
  return (
    ...
    <div className="fixed h-full w-18 md:w-80 px-2 py-4 bg-gray-800 z-99">
      <div className="grid text-white flex h-12 w-full justify-items-center items-center opacity-0 md:opacity-100 pointer-events-none my-3">
